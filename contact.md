...
You can find me on the following services:
 ...
 1. [Mastodon](https://writing.exchange/@kuranes) - An alternative to Twitter. Join one of the hundreds of [community servers](https://joinmastodon.org/communities) available, or [start your own](https://docs.joinmastodon.org/user/run-your-own/)!
 ...
 3. [PixelFed](https://pixelfed.social/merkaba) – A federated alternative service to Instagram. Many [servers](https://pixelfed.org/join) open for registration.
 4. [Libre.fm](https://libre.fm/user/Merkaba) – Last.fm alternative. Currently, under rewrite and changing to [Nixtape](https://nixtape.org/).
 5. [LinkedIn](https://www.linkedin.com/in/terrancebrownza/) – A network for professionals. Hopefully I can shift off this soon to [Flockingbird](https://flockingbird.social/).
